...
pubDate: 2025-07-03T19:00:00+09:00
...
## 開発生産性測定のトレードオフ「グッドハートの法則」はもっと悲観的に捉えるべきだった - Kent Beck
...
## ペアプロ × 生成AI：現場での実践と課題について - 株式会社コドモン
...
## レベル1の開発生産性向上に取り組む─日々の作業の効率化・自動化を通じた改善活動 - ソーシャルデータバンク株式会社
...
## 開発組織の進化・スケーリングと「開発生産性」 - 吉羽龍太郎

そのうち [Ryuzee.com](https://slide.meguro.ryuzee.com/) にスライドが掲載されるはず。

全体を通して、開発生産性というものはプロダクトの成長具合やチームの特性などによって、見るべき指標は異なるということを主張していた。
スライドがまだ見当たらないので、公開されたら読み直して思い出しつつ追記する。

## マネジメントの効力感で実現する、持続可能な開発組織 - 株式会社Hacobu
...
## GitHub が見据える開発の次：AIと人間の共創最前線 - 服部佑樹
